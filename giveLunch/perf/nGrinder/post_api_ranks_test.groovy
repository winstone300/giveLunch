...
class GiveLunchPostRankOnlyTest {
    ...
    static void beforeProcess() {
        ...
        runId = props.getProperty("runId", "post-rank-${System.currentTimeMillis()}")

        testPostRank = new GTest(1, "POST /api/ranks")
    }
    ...
    void postRankScenario() {
        ...
        HTTPResponse resp = postRankRequest.POST(urlFor("/api/ranks"), jsonBytes([name: name]))
