...
public class EmailVerificationController {
    ...
    public ResponseEntity<Map<String, String>> sendVerification(@Valid @RequestBody EmailVerificationRequestDto req) {
    ...
    public ResponseEntity<Map<String, String>> verifyCode(@Valid @RequestBody EmailVerificationConfirmDto req) {
